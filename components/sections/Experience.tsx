  ...
  const experiences = [
    {
      ...
      description: 'Actively participate in the development and maintenance process of the LMS (Learning Management System) and CMS (Conference Management System).',
    ...
    },
    {
      ...
      description: 'Working on a internship project about CCTV monitoring system by integrating the RTSP protocol with Laravel for real-time live streaming',
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
                  <div className="flex flex-col gap-3">
                    <h3 className="text-2xl md:text-3xl font-black text-black tracking-tight flex items-center gap-3">
                      <Briefcase size={28} strokeWidth={3} className="shrink-0" />
                      {exp.role}
                    </h3>
                    <p className="text-xl md:text-2xl font-bold text-black/80">{exp.company}</p>
                  </div>
