...
const Contact = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center px-4 pt-40 pb-20 bg-cyan-200 overflow-x-hidden">
      {/* Decorative neobrutalism elements */}
      <div className="absolute top-10 right-10 w-20 h-20 bg-white border-2 border-black rotate-12 opacity-40 hidden md:block z-0" />
      <div className="absolute top-18 right-6 w-10 h-10 bg-yellow-400 border-2 border-black -rotate-6 opacity-60 hidden md:block z-0" />
      <div className="absolute bottom-20 left-8 w-14 h-14 bg-violet-300 border-2 border-black rotate-3 opacity-50 hidden md:block z-0" />
      <div
      ...
      <div className="max-w-4xl w-full mx-auto relative z-10">
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="bg-[#faf8f3] border-2 border-black p-8 md:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative"
          >
            ...
            {submitStatus === "error" && (
              <div className="mb-6 p-4 bg-red-200 border-2 border-black flex items-center gap-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p className="font-bold text-red-900">
                  Failed to send message. Please try again or check setup.
                </p>
              </div>
            )}
